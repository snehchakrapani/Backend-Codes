...
namespace TaxiBookingService.Services
{
    public class BookingService : IBookingService
    {
        ...
        public async Task<BookingResponseDto> BookRideAsync(int userId, BookingRequestDto dto)
        {
            ...
            return MapToResponseDto(booking, bestDriver);
        }

        public async Task<BookingResponseDto> GetBookingStatusAsync(int bookingId)
        {
            ...
            return MapToResponseDto(booking, booking.Driver);
        }
        ...
        public async Task<List<BookingResponseDto>> GetUserHistoryAsync(int userId)
        {
            ...
            return bookings
                .Select(b => MapToResponseDto(b, b.Driver))
                .ToList();
        }

        private static BookingResponseDto MapToResponseDto(Booking booking, Driver? driver)
        {
